...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    fetch(`${import.meta.env.VITE_SUPABASE_FUNCTIONS_URL}/generate-score?submissionId=${localStorage.getItem('SubmissionID') ?? 9999999}&language=${language.toUpperCase() ?? 'RO'}`)
