...
export default function Questionaire() {
  ...
  useEffect(() => {
    ...
    fetch(`${import.meta.env.VITE_SUPABASE_FUNCTIONS_URL}/get-questionnaire?language=${language}`)
  ...
  const next = async (pageNo, dataPointId, dataPointName, a, type) => {
    ...
    if(type !== "intro" && type !== "media") {
      ...
      try {
        const response = await fetch(`${import.meta.env.VITE_SUPABASE_FUNCTIONS_URL}/update-response`, {
          method: 'POST',
          headers: {
