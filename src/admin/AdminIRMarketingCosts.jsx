...
export default function AdminIRMarketingCosts() {
  ...
  const loadData = useCallback(() => {
    ...
    fetchAdminIRMarketingRange(range)
  ...
  const saveEdit = async (day) => {
    ...
    setSaving(true);
    try {
      await setAdminIRMarketingDay(day, parsed);
      setEditingDay(null);
      setEditValue("");
      loadData();
    } catch (err) {
    ...
    <div className="admin-shell">
      <header className="admin-header">
        ...
        <div className="admin-header-actions">
          <Link to="/admin/ir" className="admin-ghost-button">Dashboard</Link>
      ...
      <main className="admin-container">
        <section className="admin-section">
          <div className="admin-section-prehead">Insulin Resistance · Marketing</div>
